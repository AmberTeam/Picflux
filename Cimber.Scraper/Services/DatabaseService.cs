        ...
        public Film? AddFilm(Film film)
        {
            try
            {
                using (var connection = new NpgsqlConnection(connectionString))
                {
                    ...
                    film.LowercaseEnglishTitle = removeSpecialCharacters(film.EnglishTitle!).ToLower();
                    film.LowercaseUkrainianTitle = removeSpecialCharacters(film.UkrainianTitle!).ToLower();
                    film.LowercaseRussianTitle = removeSpecialCharacters(film.RussianTitle!).ToLower();
                    ...
                    using (var insertCommand = new NpgsqlCommand())
                    {
                        ...
                        insertCommand.Parameters.AddWithValue("LowercaseEnglishTitle", film.LowercaseEnglishTitle ?? "");
                        insertCommand.Parameters.AddWithValue("LowercaseUkrainianTitle", film.LowercaseUkrainianTitle ?? "");
                        insertCommand.Parameters.AddWithValue("LowercaseRussianTitle", film.LowercaseRussianTitle ?? "");
