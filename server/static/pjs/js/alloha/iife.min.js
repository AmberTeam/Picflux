!function(e, n) {
    "object" == typeof exports && "undefined" != typeof module ? n(exports) : "function" == typeof define && define.amd ? define(["exports"], n) : n((e = "undefined" != typeof globalThis ? globalThis : e || self).FingerprintJS = {})
}(this, (function(e) {
    "use strict";
    var n = function() {
    ...
    function b(e, n) {
        n = n || 0;
        var t, r = (e = e || "").length % 16, o = e.length - r, i = [0, n], a = [0, n], c = [0, 0], u = [0, 0], l = [2277735313, 289559509], b = [1291169091, 658871167];
        for (t = 0; t < o; t += 16)
            ...
            c = m(c = d(c, l), 31),
            i = s(i = m(i = h(i, c = d(c, b)), 27), a),
            i = s(d(i, [0, 5]), [0, 1390208809]),
            u = m(u = d(u, b), 33),
            a = s(a = m(a = h(a, u = d(u, l)), 31), i),
            a = s(d(a, [0, 5]), [0, 944331445]);
        switch (c = [0, 0],
        u = [0, 0],
        r) {
        case 15:
        ...
        case 9:
            u = d(u = h(u, [0, e.charCodeAt(t + 8)]), b),
            a = h(a, u = d(u = m(u, 33), l));
        case 8:
        ...
        case 1:
            c = d(c = h(c, [0, e.charCodeAt(t)]), l),
            i = h(i, c = d(c = m(c, 31), b))
        }
        return i = s(i = h(i, [0, e.length]), a = h(a, [0, e.length])),
        a = s(a, i),
        i = s(i = v(i), a = v(a)),
        a = s(a, i),
        ...
        function() {
            return t(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                    case 0:
                        return T(e = D()) ? P ? [2, o(P)] : C() ? [4, (t = document,
    ...
    var ne = {
            ...
            return t(this, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    ...
                    case 0:
                        ...
                        t = Object.keys(e),
                        [4, B((a = []).concat.apply(a, t.map((function(n) {
                            return e[n]
                        }
                        ))))]) : [2, void 0];
                    case 1:
        ...
        fontPreferences: function() {
            return function(e, n) {
                ...
                return R((function(t, r) {
                    ...
                    X() ? a.style.zoom = "" + 1 / r.devicePixelRatio : F() && (a.style.zoom = "reset");
                    var u = i.createElement("div");
                    return u.textContent = o(Array(n / 20 << 0)).map((function() {
                        return "word"
                    }
                    )).join(" "),
                    a.appendChild(u),
                    ...
                    var d = function() {
                      ...
                      , m = function() {
                        try {
                            ...
                            case "suspended":
                                document.hidden || l++,
                                u && l >= n ? c(M("suspended")) : setTimeout(m, t)
                            }
                        } catch (r) {
                            c(r)
                        }
        ...
        languages: function() {
            ...
            Array.isArray(n.languages))
                X() && w([!("MediaSettingsRange"in (e = window)), "RTCEncodedAudioFrame"in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || t.push(n.languages);
        ...
        math: function() {
            var e, n = q.acos || $, t = q.acosh || $, r = q.asin || $, o = q.asinh || $, i = q.atanh || $, a = q.atan || $, c = q.sin || $, u = q.sinh || $, l = q.cos || $, s = q.cosh || $, d = q.tan || $, m = q.tanh || $, f = q.exp || $, h = q.expm1 || $, v = q.log1p || $;
            return {
