                        ...
                        <div className={cl.Reply_content}>
                            {
                                props.message.refer._id && props.message.refer._id !== "deleted"
                                    ...
                                    :
                                    <div className={cl.Reply_payload}>
                                        {translate("inbox.chat.message.deleted")}
                                    </div>   
                            }
                        </div>
                    </div>
            ...
            <div className={cl.Message_actions}>
                <div className={`${cl.Message_action} ${controllerActive ? cl.Active : ""}`} onClick={() => !controllerActive && setControllerActive(true)}>
                    ...
                    <div className={cl.Action_controller}>
                        <button title={translate("inbox.chat.message.title.repl")} className={cl.Action} onClick={() => {
                        ...
                        </button>
                        {
                            ...
                            <>
                                <button title={translate("inbox.chat.message.title.del")} className={cl.Action} onClick={() => props.onDelete(props.message)}>
                                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16">
                                        <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                                    </svg>
                                </button>
                                <button title={translate("inbox.chat.message.title.edit")} className={cl.Action} onClick={() => props.onEdit(props.message)}>
                        ...
                        <button title={translate("inbox.chat.message.title.cl")} className={cl.Action} onClick={() => setControllerActive(false)}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
